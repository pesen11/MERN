...
router.post("/register", setDestination, uploader.single("image"), authCtrlObject.register);

router.post("/login", authCtrlObject.login);

router.get("/verify-login", authMiddleware.loginCheck, authCtrlObject.verifyUser);
